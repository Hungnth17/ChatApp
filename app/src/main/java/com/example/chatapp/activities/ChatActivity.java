...
public class ChatActivity extends BaseActivity {
    ...
    public void addConversion(HashMap<String, Object> conversion) {
    ...
    private void updateConversion(String message) {
        DocumentReference documentReference = database.collection(Constants.KEY_COVERSATIONS).document(conversionId);
